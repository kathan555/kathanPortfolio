          ...
          <div className="hidden md:flex items-center gap-1">
              ...
              link.children ? (
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      link.children.some(c => pathname.startsWith(c.href))
                        ? "text-blue-400" : "text-muted-foreground hover:text-foreground"
                    )}
                  >
                    {link.label}
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === link.href ? "text-blue-400" : "text-muted-foreground hover:text-foreground"
                  )}
                >
                  {link.label}
                </Link>
            ...
            <div className="flex items-center gap-2 ml-2">
              ...
              <a
                ...
                download
                className="px-4 py-2 text-sm font-medium bg-blue-500/10 border border-blue-500/30 text-blue-400 rounded-lg hover:bg-blue-500/20 hover:border-blue-500/50 transition-all flex items-center gap-1.5"
              >
                Resume
          ...
          >
            <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1">
              {navLinks.map((link, i) =>
                link.children ? (
                  <div key={link.label}>
                    <p className="px-4 py-2 text-xs text-muted-foreground uppercase tracking-wider font-medium">
                      {link.label}
                    </p>
                    {link.children.map((child) => (
                      <Link
                  ...
                  >
                    <Link
                      ...
                      className={cn(
                        ...
                        pathname === link.href ? "text-blue-400 bg-blue-500/5" : "text-muted-foreground hover:text-foreground hover:bg-blue-500/5"
                      )}
                    >
                      {link.label}
                    </Link>
              ...
              <a href="/Kathan_Patel_Resume.pdf" download className="block px-4 py-3 text-sm font-medium text-blue-400 hover:bg-blue-500/10 rounded-lg transition-colors">
                Download Resume ↓
              </a>
            </div>
          </motion.div>
